<!-- Datepicker Komponente Version Options API
      Beispiel-Code war in Options-API geschrieben.
      Props wären dynamisch.
      Formular findet handleSubmit nicht.
      Submit kann darum nur "Button gedrückt" 
      ABHILFE: Siehe Version Composition API -->
